...
<html>
    ...
    <body>
       ...
       <div id="content">
        <h1>Edit News</h1>&nbsp;&nbsp;&nbsp;&nbsp;
        <form action='/TotoroEmergencyMedical/newsController' method='post' >
        ...
        <div id="paradiv3" style="display:none;">Body of Paragraph 3: <textarea id="body3" name="body3" rows="5" cols="100" disabled="true" style="color:grey; font-size:18px;padding:5px;" onkeyup="apos(this)" onkeydown="apos(this)" onkeypress="apos(this)"><%=body[2]%></textarea></div>
